...
class AChestActor_C : public AChest
{
    ...
    TArray<class AVRHandFingers_C*> CurrentlyOverlappingHand;
    bool HandGrabbing;
    TEnumAsByte<hand> HandGrabbingSide;
    class AVRHandFingers_C* HandGrabbingActor;
    FVector StartingGrabLocation;
    float TopStartRotation;
    class AVRHandFingers_C* LockCurrentlyOverlappingHand;
    class AVRHandFingers_C* LockHandGrabbingActor;
