...
class ALevelSequenceActor : public AActor
{
    ...
    FLevelSequenceCameraSettings CameraSettings;                                      // 0x0268 (size: 0x2)
    class ULevelSequenceBurnInOptions* BurnInOptions;                                 // 0x0270 (size: 0x8)
    class UMovieSceneBindingOverrides* BindingOverrides;                              // 0x0278 (size: 0x8)
    uint8 bAutoPlay;                                                                  // 0x0280 (size: 0x1)
    uint8 bOverrideInstanceData;                                                      // 0x0280 (size: 0x1)
    uint8 bReplicatePlayback;                                                         // 0x0280 (size: 0x1)
    class UObject* DefaultInstanceData;                                               // 0x0288 (size: 0x8)
    class ULevelSequenceBurnIn* BurnInInstance;                                       // 0x0290 (size: 0x8)
    bool bShowBurnin;                                                                 // 0x0298 (size: 0x1)
...
{
    FLevelSequencePlayerOnCameraCut OnCameraCut;                                      // 0x0680 (size: 0x10)
