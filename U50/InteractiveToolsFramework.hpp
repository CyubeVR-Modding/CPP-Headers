...
{
    FLinearColor Color;                                                               // 0x0440 (size: 0x10)
    float HoverSizeMultiplier;                                                        // 0x0450 (size: 0x4)
    float PixelHitDistanceThreshold;                                                  // 0x0454 (size: 0x4)
...
{
    FVector Direction;                                                                // 0x0460 (size: 0xC)
    float Gap;                                                                        // 0x046C (size: 0x4)
    float Length;                                                                     // 0x0470 (size: 0x4)
    float Thickness;                                                                  // 0x0474 (size: 0x4)

}; // Size: 0x480

class UGizmoBoxComponent : public UGizmoBaseComponent
{
    FVector Origin;                                                                   // 0x0460 (size: 0xC)
    FQuat Rotation;                                                                   // 0x0470 (size: 0x10)
    FVector Dimensions;                                                               // 0x0480 (size: 0xC)
    float LineThickness;                                                              // 0x048C (size: 0x4)
    bool bRemoveHiddenLines;                                                          // 0x0490 (size: 0x1)
    bool bEnableAxisFlip;                                                             // 0x0491 (size: 0x1)

}; // Size: 0x4A0

class UGizmoCircleComponent : public UGizmoBaseComponent
{
    FVector Normal;                                                                   // 0x0460 (size: 0xC)
    float Radius;                                                                     // 0x046C (size: 0x4)
    float Thickness;                                                                  // 0x0470 (size: 0x4)
    int32 NumSides;                                                                   // 0x0474 (size: 0x4)
    bool bViewAligned;                                                                // 0x0478 (size: 0x1)
    bool bOnlyAllowFrontFacingHits;                                                   // 0x0479 (size: 0x1)
...
{
    FVector Normal;                                                                   // 0x0460 (size: 0xC)
    float HandleSize;                                                                 // 0x046C (size: 0x4)
    float Thickness;                                                                  // 0x0470 (size: 0x4)
    FVector Direction;                                                                // 0x0474 (size: 0xC)
    float Length;                                                                     // 0x0480 (size: 0x4)
    bool bImageScale;                                                                 // 0x0484 (size: 0x1)

}; // Size: 0x490

class UGizmoRectangleComponent : public UGizmoBaseComponent
{
    FVector DirectionX;                                                               // 0x0460 (size: 0xC)
    FVector DirectionY;                                                               // 0x046C (size: 0xC)
    float OffsetX;                                                                    // 0x0478 (size: 0x4)
    float OffsetY;                                                                    // 0x047C (size: 0x4)
    float LengthX;                                                                    // 0x0480 (size: 0x4)
    float LengthY;                                                                    // 0x0484 (size: 0x4)
    float Thickness;                                                                  // 0x0488 (size: 0x4)
    uint8 SegmentFlags;                                                               // 0x048C (size: 0x1)
