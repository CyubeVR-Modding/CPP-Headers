...
{
    FCameraLookatTrackingSettings LookatTrackingSettings;                             // 0x07A0 (size: 0x50)
...
{
    FCameraFilmbackSettings FilmbackSettings;                                         // 0x07C0 (size: 0xC)
    FCameraFilmbackSettings Filmback;                                                 // 0x07CC (size: 0xC)
    FCameraLensSettings LensSettings;                                                 // 0x07D8 (size: 0x18)
    FCameraFocusSettings FocusSettings;                                               // 0x07F0 (size: 0x58)
    float CurrentFocalLength;                                                         // 0x0848 (size: 0x4)
    float CurrentAperture;                                                            // 0x084C (size: 0x4)
    float CurrentFocusDistance;                                                       // 0x0850 (size: 0x4)
    TArray<FNamedFilmbackPreset> FilmbackPresets;                                     // 0x0860 (size: 0x10)
    TArray<FNamedLensPreset> LensPresets;                                             // 0x0870 (size: 0x10)
    FString DefaultFilmbackPresetName;                                                // 0x0880 (size: 0x10)
    FString DefaultFilmbackPreset;                                                    // 0x0890 (size: 0x10)
    FString DefaultLensPresetName;                                                    // 0x08A0 (size: 0x10)
    float DefaultLensFocalLength;                                                     // 0x08B0 (size: 0x4)
    float DefaultLensFStop;                                                           // 0x08B4 (size: 0x4)
