...
{
    class AChaosSolverActor* ChaosSolverActor;                                        // 0x0470 (size: 0x8)
    class UGeometryCollection* RestCollection;                                        // 0x0558 (size: 0x8)
    TArray<class AFieldSystemActor*> InitializationFields;                            // 0x0560 (size: 0x10)
    bool Simulating;                                                                  // 0x0570 (size: 0x1)
    EObjectStateTypeEnum ObjectType;                                                  // 0x0578 (size: 0x1)
    bool EnableClustering;                                                            // 0x0579 (size: 0x1)
    int32 ClusterGroupIndex;                                                          // 0x057C (size: 0x4)
    int32 MaxClusterLevel;                                                            // 0x0580 (size: 0x4)
    TArray<float> DamageThreshold;                                                    // 0x0588 (size: 0x10)
    EClusterConnectionTypeEnum ClusterConnectionType;                                 // 0x0598 (size: 0x1)
    int32 CollisionGroup;                                                             // 0x059C (size: 0x4)
    float CollisionSampleFraction;                                                    // 0x05A0 (size: 0x4)
    float LinearEtherDrag;                                                            // 0x05A4 (size: 0x4)
    float AngularEtherDrag;                                                           // 0x05A8 (size: 0x4)
    class UChaosPhysicalMaterial* PhysicalMaterial;                                   // 0x05B0 (size: 0x8)
    EInitialVelocityTypeEnum InitialVelocityType;                                     // 0x05B8 (size: 0x1)
    FVector InitialLinearVelocity;                                                    // 0x05BC (size: 0xC)
    FVector InitialAngularVelocity;                                                   // 0x05C8 (size: 0xC)
    ...
    FGeometryCollectionComponentNotifyGeometryCollectionPhysicsStateChange NotifyGeometryCollectionPhysicsStateChange; // 0x0630 (size: 0x10)
    void NotifyGeometryCollectionPhysicsStateChange(class UGeometryCollectionComponent* FracturedComponent);
    FGeometryCollectionComponentNotifyGeometryCollectionPhysicsLoadingStateChange NotifyGeometryCollectionPhysicsLoadingStateChange; // 0x0640 (size: 0x10)
    void NotifyGeometryCollectionPhysicsLoadingStateChange(class UGeometryCollectionComponent* FracturedComponent);
    FGeometryCollectionComponentOnChaosBreakEvent OnChaosBreakEvent;                  // 0x0668 (size: 0x10)
    void OnChaosBreakEvent(const FChaosBreakEvent& BreakEvent);
    float DesiredCacheTime;                                                           // 0x0678 (size: 0x4)
    bool CachePlayback;                                                               // 0x067C (size: 0x1)
    FGeometryCollectionComponentOnChaosPhysicsCollision OnChaosPhysicsCollision;      // 0x0680 (size: 0x10)
    void OnChaosPhysicsCollision(const FChaosPhysicsCollisionInfo& CollisionInfo);
    bool bNotifyBreaks;                                                               // 0x0690 (size: 0x1)
    bool bNotifyCollisions;                                                           // 0x0691 (size: 0x1)
    bool bEnableReplication;                                                          // 0x0692 (size: 0x1)
    bool bEnableAbandonAfterLevel;                                                    // 0x0693 (size: 0x1)
    int32 ReplicationAbandonClusterLevel;                                             // 0x0694 (size: 0x4)
    FGeometryCollectionRepData RepData;                                               // 0x0698 (size: 0x18)
    class UBodySetup* DummyBodySetup;                                                 // 0x08C8 (size: 0x8)
