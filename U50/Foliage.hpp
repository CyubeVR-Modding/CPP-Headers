...
{
    FFoliageInstancedStaticMeshComponentOnInstanceTakePointDamage OnInstanceTakePointDamage; // 0x0670 (size: 0x10)
    ...
    FFoliageInstancedStaticMeshComponentOnInstanceTakeRadialDamage OnInstanceTakeRadialDamage; // 0x0680 (size: 0x10)
    ...
    FGuid GenerationGuid;                                                             // 0x0690 (size: 0x10)
...
class UFoliageType : public UObject
{
    ...
    FBodyInstance BodyInstance;                                                       // 0x0158 (size: 0x158)
    TEnumAsByte<EHasCustomNavigableGeometry::Type> CustomNavigableGeometry;           // 0x02B0 (size: 0x1)
    FLightingChannels LightingChannels;                                               // 0x02B1 (size: 0x1)
    uint8 bRenderCustomDepth;                                                         // 0x02B4 (size: 0x1)
    ERendererStencilMask CustomDepthStencilWriteMask;                                 // 0x02B8 (size: 0x1)
    int32 CustomDepthStencilValue;                                                    // 0x02BC (size: 0x4)
    int32 TranslucencySortPriority;                                                   // 0x02C0 (size: 0x4)
    float CollisionRadius;                                                            // 0x02C4 (size: 0x4)
    float ShadeRadius;                                                                // 0x02C8 (size: 0x4)
    int32 NumSteps;                                                                   // 0x02CC (size: 0x4)
    float InitialSeedDensity;                                                         // 0x02D0 (size: 0x4)
    float AverageSpreadDistance;                                                      // 0x02D4 (size: 0x4)
    float SpreadVariance;                                                             // 0x02D8 (size: 0x4)
    int32 SeedsPerStep;                                                               // 0x02DC (size: 0x4)
    int32 DistributionSeed;                                                           // 0x02E0 (size: 0x4)
    float MaxInitialSeedOffset;                                                       // 0x02E4 (size: 0x4)
    bool bCanGrowInShade;                                                             // 0x02E8 (size: 0x1)
    bool bSpawnsInShade;                                                              // 0x02E9 (size: 0x1)
    float MaxInitialAge;                                                              // 0x02EC (size: 0x4)
    float MaxAge;                                                                     // 0x02F0 (size: 0x4)
    float OverlapPriority;                                                            // 0x02F4 (size: 0x4)
    FFloatInterval ProceduralScale;                                                   // 0x02F8 (size: 0x8)
    FRuntimeFloatCurve ScaleCurve;                                                    // 0x0300 (size: 0x88)
    int32 ChangeCount;                                                                // 0x0388 (size: 0x4)
    uint8 ReapplyDensity;                                                             // 0x038C (size: 0x1)
    uint8 ReapplyRadius;                                                              // 0x038C (size: 0x1)
    uint8 ReapplyAlignToNormal;                                                       // 0x038C (size: 0x1)
    uint8 ReapplyRandomYaw;                                                           // 0x038C (size: 0x1)
    uint8 ReapplyScaling;                                                             // 0x038C (size: 0x1)
    uint8 ReapplyScaleX;                                                              // 0x038C (size: 0x1)
    uint8 ReapplyScaleY;                                                              // 0x038C (size: 0x1)
    uint8 ReapplyScaleZ;                                                              // 0x038C (size: 0x1)
    uint8 ReapplyRandomPitchAngle;                                                    // 0x038D (size: 0x1)
    uint8 ReapplyGroundSlope;                                                         // 0x038D (size: 0x1)
    uint8 ReapplyHeight;                                                              // 0x038D (size: 0x1)
    uint8 ReapplyLandscapeLayers;                                                     // 0x038D (size: 0x1)
    uint8 ReapplyZOffset;                                                             // 0x038D (size: 0x1)
    uint8 ReapplyCollisionWithWorld;                                                  // 0x038D (size: 0x1)
    uint8 ReapplyVertexColorMask;                                                     // 0x038D (size: 0x1)
    uint8 bEnableDensityScaling;                                                      // 0x038D (size: 0x1)
    uint8 bEnableDiscardOnLoad;                                                       // 0x038E (size: 0x1)
    TArray<class URuntimeVirtualTexture*> RuntimeVirtualTextures;                     // 0x0390 (size: 0x10)
    int32 VirtualTextureCullMips;                                                     // 0x03A0 (size: 0x4)
    ERuntimeVirtualTextureMainPassType VirtualTextureRenderPassType;                  // 0x03A4 (size: 0x1)

}; // Size: 0x3A8

class UFoliageType_Actor : public UFoliageType
{
    TSubclassOf<class AActor> ActorClass;                                             // 0x03A8 (size: 0x8)
    bool bShouldAttachToBaseComponent;                                                // 0x03B0 (size: 0x1)

}; // Size: 0x3B8

class UFoliageType_InstancedStaticMesh : public UFoliageType
{
    class UStaticMesh* Mesh;                                                          // 0x03A8 (size: 0x8)
    TArray<class UMaterialInterface*> OverrideMaterials;                              // 0x03B0 (size: 0x10)
    TSubclassOf<class UFoliageInstancedStaticMeshComponent> ComponentClass;           // 0x03C0 (size: 0x8)
