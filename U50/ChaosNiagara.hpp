...
{
    class UBlueprint* BlueprintSource;                                                // 0x0038 (size: 0x8)
    class AActor* SourceActor;                                                        // 0x0040 (size: 0x8)
    FIntVector FieldDimensions;                                                       // 0x0048 (size: 0xC)
    FVector MinBounds;                                                                // 0x0054 (size: 0xC)
    FVector MaxBounds;                                                                // 0x0060 (size: 0xC)
