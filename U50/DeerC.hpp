...
class ADeerC_C : public ADeerCPP
{
    ...
    class AMC_GameState* K2Node_DynamicCast_AsCube_Game_State_BP_1;
    ...
    class AMC_GameState* K2Node_DynamicCast_AsCube_Game_State_BP_2;
    bool K2Node_DynamicCast_bSuccess_6;
    class AChunkManager* K2Node_DynamicCast_AsMy_Chunk_Manager_1;
